...
const config = {
    role: "owner",
    token: "NTc2NDEyOTY2MDkwNDQwNzM0.XNbr0A.9EAthylOO5ECsCMHSN1XvANWVW4"
};
...
class Bot {
    ...
    onReady() {
        ...
        client2.channels.get('575389016510431233').send("**Server Started: Instant-Merge**" + "```" + port2 + "\n" + currentgamemode2 + "\n" + bot1 + "```" ) //listening on port port
        client2.channels.get('575389368865390592').send("**Server Started: Instant-Merge**")
    };
