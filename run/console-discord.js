...
const config = {
    role: "owner",
    token: "NTc2NzkwMzgzNDkzNjQ0MzAx.XNloIQ.8X9cwqbYb1qbz8GQnu1MQKPPa_E"
};
...
class Bot {
    ...
    onReady() {
        ...
        client2.channels.get('575389133934034994').send("**Server Started: Mega**" + "```" + port2 + "\n" + currentgamemode2 + "\n" + bot1 + "```" ) //listening on port port
        client2.channels.get('575389368865390592').send("**Server Started: Mega**")
    };
