// ==UserScript==
// @name         THE NEW AGAR.IO MAP 
// @namespace    THE NEW AGAR.io MAP
// @version      1.0
...
(function() {
    ...
    Event.prototype = {
        ...
        render: function(ctx, xyTransform, maxsize){
            ...
            switch(this.type){
                case Event.TYPE_NORMAL:    color = "#000000"; break;
                case Event.TYPE_FEED:      color = "#282828"; break;
                case Event.TYPE_FAKESPACE: color = "#282828"; break;
                case Event.TYPE_RUN:       color = "#282828"; break;
            }
